class CartsController < ApplicationController
  ...
  def show
    ...
    Services::CartService::CartDiscountApplier.new(@cart_items).call # To apply best discounts available at the moment
    @cart_details = Services::CartService::CartTotalCalculator.new(@user).call
  end

  def apply_coupon
    @cart_details = Services::CartService::CartTotalCalculator.new(@user, params[:code]).call
